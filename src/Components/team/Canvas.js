...
//     // 소켓 받기
//     socket.on("draw", (data) =>
//       drawLine(ctx, data.x1, data.y1, data.x2, data.y2, data.color)
//     );
//   };

// <<<<<<< Updated upstream:src/Components/team/Canvas.js
//     // nativeEvent => js에서의 e
//     const drawing = ({ nativeEvent }) => {
//         const { offsetX, offsetY } = nativeEvent;
//         if (ctx) {
...
//     setColor(c);
//   };
// >>>>>>> Stashed changes:src/Components/Canvas.js
...
//       context.fillRect(
//         Math.round(x1 + Math.cos(ang) * i),
//         Math.round(y1 + Math.sin(ang) * i),
//         5,
//         5
//       );
//   };
