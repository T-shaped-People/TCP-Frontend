...
import '../styleComponents/BeforeLogin.css'
        ...
        <div className={"root-div"}>
            <header>
                <nav className={"container"}>
                    <div>
                        <img src={"images/tcpicon2.png"} className="nav--logo" onClick={() => navigate('/')} alt={"profile"}/>
                    </div>
                    <div className={"container--div"}>
                        <img src={"images/person.png"} className={"nav--personImg"} alt={"profile"}/>
