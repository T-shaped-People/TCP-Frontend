...
export default function Content()
{
    ...
    const [content, setContent] = React.useState({  // 글 
        commentCnt: 0,
        content: '',
        createdAt: '',
        hit: 0,
            ...
            <div className="content">
                <div className='content-header'>
                    ...
                    <div className='content-info'>
                        <span className='content-info-comment'>댓글: {content.commentCnt}</span>
                ...
                <div className='write-comment'>
                    ...
                    <div className='comment-button-div'>
                        <button onClick={reloadComment} className='reload-button'>댓글 새로고침</button>
                        <button onClick={postComment} className="write-comment-button">작성</button>
                        {deleted ? <button onClick={deletePost} className="delete-button">글 삭제</button> : <></>}
                    </div>
                </div>
                        ...
                        if(value.deleted !== true){
                            return(
                                <div className='read-comment'>
                                    <span className='read-comment-nickname'>{value.nickname}</span>
